using System;
using Content.Server._OpenSpace.Combat.CloseQuarterCooking.Systems;
...
namespace Content.Server._OpenSpace.Combat.CloseQuarterCooking.Components;

[RegisterComponent, ComponentProtoName("CloseQuarterCookingMastery")]
[Access(typeof(CloseQuarterCookingMasterySystem))]
public sealed partial class CloseQuarterCookingMasteryComponent : Component, ICombatMasteryTemplateProvider
{
    ...
    public int StylePriority => CurrentPriority;
