...
chem-master-window-pill-buffer-tab = Буфер для таблеток
chem-master-window-container-label = Контейнер
chem-master-window-amount-placeholder = Сумма трансфера
...
chem-master-window-pill-buffer-text = Буфер для таблеток
chem-master-window-pill-buffer-label = буфер таблеток:
chem-master-window-pill-buffer-empty-text = Буфер для таблеток пуст.
...
chem-master-window-set-amount-label = Указать количество
chem-master-window-transfer-button = Перенести
chem-master-window-sort-method-tooltip = Выберите метод сортировки вашего буфера.
...
chem-master-window-transferring-label = Перенос: [color={$color}]{$quantity}[/color]
chem-master-window-transferring-default-label = Перенос: [color=#ffffff]50[/color]
